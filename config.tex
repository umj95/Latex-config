...
%%%%%%%%%%%%%%%%%%%
    ...
    \def\authormail{a@b} %Email
    \def\matrikelnr{asfasdf} %student number
    \def\authoraddress{adfasdf} %address
    ...
    % Paper Info
    \title{My awesome Paper} %title of the paper
    \date{\today}
    \def\papertype{asdfsda} %form of the paper (term paper, Proseminararbeit, etc)
