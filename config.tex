...
%%%%%%%%%%%%%%%%%%%
    ...
    \newcommand{\authoraddress}{Dr.-Hipp-Str. 5\\***REMOVED*** ***REMOVED***} %Addresse

    % Department & Correction Info
    \newcommand{\city}{***REMOVED***} %Stadt (Für Plagiatserkl.)
    \newcommand{\university}{Universität ***REMOVED***} %Uni
    \newcommand{\faculty}{Fakultät für Philosophie, Kunst-, Geschichts- \& Gesellschaftswissenschaften} %Fakultät
    \newcommand{\department}{Institut für ***REMOVED***} %Institut
    ...
    \newcommand{\keywords}{Latex, Lilypond, ***REMOVED***, Notensatz} %Schlagwörter
